<div class="modal fade" id="kt_modal_add_address" tabindex="-1" aria-hidden="true" style="display: none;">
    <!--begin::Modal dialog-->
            ...
            <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#" id="kt_modal_add_address_form">
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_address_scroll"
                        ...
                        data-kt-scroll-wrappers="#kt_modal_add_address_scroll" data-kt-scroll-offset="300px" style="">
                        ...
                        <div id="kt_modal_add_address_billing_info" class="collapse show">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                ...
                                <select name="country" aria-label="Select a Country" data-control="select2"
                                    data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_add_address"
                                    class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                    data-select2-id="select2-data-13-le6y" tabindex="-1" aria-hidden="true">
                                    <option value="" data-select2-id="select2-data-15-t4c1">Select a Country...</option>
