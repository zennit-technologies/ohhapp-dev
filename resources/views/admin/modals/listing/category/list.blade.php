<div class="modal bg-white fade" tabindex="-1" id="kt_modal_category">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content shadow-none">
            <div class="modal-header">
                <h5 class="modal-title">List Categories</h5>
                            ...
                            <table class="table display nowrap align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <thead> 
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Approved By</th>
