    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header py-3" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder fs-4">Add New Vendor</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 my-2">
                ...
                <form id="kt_modal_add_user_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold mb-2">Select Language</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="language" aria-label="Select a Language" class="form-select form-select-solid">
                        ...
                        <!--begin::Input-->
                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">Refer Via</label>
                            <!--begin::Options-->
                            <div class="d-flex align-items-center mt-3">
                                <!--begin::Option-->
                                <label class="form-check form-check-inline form-check-solid me-5">
                                    <input class="form-check-input" name="refer_via" type="radio" value="1" />
                                    <span class="fw-bold ps-2 fs-6">Admin</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label class="form-check form-check-inline form-check-solid">
                                    <input class="form-check-input" name="refer_via" type="radio" value="2" />
                                    <span class="fw-bold ps-2 fs-6">Vendor</span>
                                </label>
                                <!--end::Option-->
                            </div>
                            <!--end::Options-->
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fs-6 fw-bold mb-2">Select Vendor/Admin</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="refer_role" aria-label="Select a Language" class="form-select form-select-solid">
                                <option value="id">Emma Smith (smith@kpmg.com) - +91 8287110840</option>
                                <option value="id">Melody Macy (melody@altbox.com) - +91 8287161281</option>
                            </select>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
