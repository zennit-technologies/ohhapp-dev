...
<div class="modal fade modal_oohap" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content">
            ...
            <form class="form" action="#" id="kt_modal_update_user_form">
                ...
                <div class="modal-header" id="kt_modal_update_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Update Sub Admin Details</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input type="text" name="fname"
                                            ...
                                            placeholder="First name" value="Emma" />
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-lg-6 fv-row">
