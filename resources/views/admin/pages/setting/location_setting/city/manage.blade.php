        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">City Lists</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-500">List Cities</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center py-2">
                    <!--begin::Button-->
                    <a href="{{ route('setting.location_setting.city.create') }}" class="btn btn-sm btn-primary"><i
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-5">
                                        <label class="form-label fs-6 fw-bold">States:</label>
                                        <select class="form-select form-select-solid" data-control="select2"
                                            data-placeholder="Select a States">
                                            <option></option>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#kt_table_users').DataTable({
                ajax: "{{ route('ajax.location.city.json') }}",
                columns: [{
                        data: 'id',
                                        ...
                                        <div class="symbol symbol-circle symbol-30px overflow-hidden me-3">
                                            <a href="javascript:;">
                                                <div class="symbol-label">
                                                    <img src="{{ asset('admin/media/flags/${row.country_img}') }}"
                                                        alt="${row.country_id}" class="w-100 rounded-pill"  />
                                                </div>
                                            </a>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a href="javascript:;"
                                                class="text-gray-800 fw-bolder text-hover-primary mb-1">${row.country_id}</a>
                                        </div>
                                    </div>`;
                        }
                    },
                    {
                        data: 'state_id',
                        render: function(data, type, row, meta) {
                            return `<div class="fw-bold text-info fs-7">${row.state_id}</div>`;
                        }
                    }, {
                        data: 'city',
                        render: function(data, type, row, meta) {
                            return `<div class="fw-bold text-dark">${row.city}</div>`;
                        }
                    },
                    {
                        data: 'latitude',
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                            <li class="text-center"><a class="dropdown-item" href="{{ route('setting.location_setting.state.create') }}">Edit</a></li>
