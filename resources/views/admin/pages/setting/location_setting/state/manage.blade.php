        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">State Lists</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-500">List States</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center py-2">
                    <!--begin::Button-->
                    <a href="{{ route('setting.location_setting.state.create') }}" class="btn btn-sm btn-primary"><i
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search States" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#kt_table_users').DataTable({
                ajax: "{{ route('ajax.location.state.json') }}",
                columns: [{
                        data: 'id',
                    ...
                    },
                    {
                        data: 'state',
                        render: function(data, type, row, meta) {
                            return `<div class="fw-bold text-info fs-7">${row.state}</div>`;
                        }
                    }, 
                    {
                        data: 'iso2',
