...
@section('main_content')
        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Roles List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-footer flex-wrap pt-0">
                            <a href="{{ route('management.sub_admin.roles.view') }}" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
    ...
    @include('admin.modals.sub_admin.roles.create')
    @include('admin.modals.sub_admin.roles.update')
@endsection

@section('scripts')
    <script src="{{ asset('admin/js/custom/apps/user-management/roles/list/add.js') }}"></script>
    <script src="{{ asset('admin/js/custom/apps/user-management/roles/list/update-role.js') }}"></script>
@endsection
