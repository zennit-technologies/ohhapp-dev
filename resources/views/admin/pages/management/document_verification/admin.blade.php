        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Admin Documents Lists</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center py-2">
                    <!--begin::Button-->
                    <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#create_new_admin_vendor">Create New</a>
                    <!--end::Button-->
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search Admin Documents" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('management.sub_admin.view') }}">
                                            <div class="symbol-label">
                                                <img src="{{ asset('admin/media/avatars/300-7.jpg') }}" alt="Emma Smith"
                                                    class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('management.sub_admin.view') }}" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                                        <span class="text-primary">mik@pex.com</span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                <td>Aadhar Card</td>
                                <td class="text-primary fw-bolder">405683002834</td>
                                <td><a href="#" class="text-success" data-bs-toggle="modal" data-bs-target="#kt_modal_doc_verification">View Doc.</a></td>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('management.sub_admin.view') }}" class="text-gray-800 text-hover-primary mb-1">Regma Ferha</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('management.sub_admin.view') }}">
                                            <div class="symbol-label">
                                                <img src="{{ asset('admin/media/avatars/300-12.jpg') }}" alt="Emma Smith"
                                                    class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('management.sub_admin.view') }}" class="text-gray-800 text-hover-primary mb-1">Dane Vilas</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('management.sub_admin.view') }}">
                                            <div class="symbol-label">
                                                <img src="{{ asset('admin/media/avatars/300-14.jpg') }}" alt="Emma Smith"
                                                    class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('management.sub_admin.view') }}" class="text-gray-800 text-hover-primary mb-1">Herat Riaild</a>
