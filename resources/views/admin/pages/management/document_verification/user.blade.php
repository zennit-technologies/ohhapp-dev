        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Users Documents Lists</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search User Documents" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="text-primary">smith@kpmg.com</span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                <td>Aadhar Card</td>
                                <td class="text-success fw-bolder">302618569823</td>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="text-primary">olivia@corpmail.com</span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                <td>PAN Card</td>
                                <td class="text-danger fw-bolder">BWGPC4504G</td>
                                <td><a href="#" class="text-success" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_doc_verification">View Doc.</a></td>
                                <td><span class="badge badge-danger">Declined</span></td>
                                <td>14 Dec 2020, 8:43 pm</td>
