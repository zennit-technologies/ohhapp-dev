...
@section('main_content')
        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Permissions List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
    ...
    <!--end::Content wrapper-->
    @include('admin.modals.vendor.permissions.create')
    @include('admin.modals.vendor.permissions.update')
@endsection

@section('scripts')
    <script src="https://preview.keenthemes.com/metronic8/demo22/assets/js/custom/apps/user-management/permissions/list.js"></script>
    <script src="https://preview.keenthemes.com/metronic8/demo22/assets/js/custom/apps/user-management/permissions/add-permission.js"></script>
    <script src="https://preview.keenthemes.com/metronic8/demo22/assets/js/custom/apps/user-management/permissions/update-permission.js"></script>
@endsection
