...
@section('main_content')
        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Vendor Roles List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-footer flex-wrap pt-0">
                            <a href="{{ route('management.vendor.roles.view') }}" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll"
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input class="form-control form-control-solid" placeholder="Enter a role name"
                                            name="role_name" value="Administrator" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Permissions-->
    ...
    @include('admin.modals.vendor.roles.create')
    @include('admin.modals.vendor.roles.update')
@endsection

@section('scripts')
    <script src="https://preview.keenthemes.com/metronic8/demo22/assets/js/custom/apps/user-management/roles/list/add.js"></script>
    <script src="https://preview.keenthemes.com/metronic8/demo22/assets/js/custom/apps/user-management/roles/list/update-role.js"></script>
@endsection
