        ...
        <div class="app-toolbar align-items-center justify-content-between">
            ...
            <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                ...
                <div class="d-flex flex-column align-items-start me-3 gap-2">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Category Lists</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-500">List Category</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center py-2">
                    <!--begin::Button-->
                    <a href="{{ route('marketplace.category.create') }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-plus"></i> New Category</a>
                    <!--end::Button-->
                </div>
                <!--end::Actions-->
            </div>
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 pb-5" data-kt-user-table-filter="form">
                                    ...
                                    <div class="mb-5">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bold mb-3">Category Status:</label>
                                        <!--end::Label-->
                                        <!--begin::Options-->
                                        <div class="d-flex">
                                            <!--begin::Options-->
                        ...
                        <table class="table display nowrap align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Created IP</th>
...
@section('scripts')
    ...
    <script>
        ...
        function format(d) {
            let sub_cat = '';
            $(d.sub_categories).each(function(index, value) {
                sub_cat += `<div class="col d-flex justify-content-center align-items-center fw-bold">
                                <span><a href="" class="text-success">${this.name}</a></span>
                            </div>`;
            });
            
            // `d` is the original data object for the row
            return (`<div class="row">
                        <div class="col-6 text-start fw-bold">Sub Categories</div>
                        <div class="col-6 text-end fw-bold">Approved By : <a href="#">${d.approved_by}</a></div>
            ...
            var table = $('#kt_table_users').DataTable({
                ...
                columns: [{
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="{{ route('management.user_management.view') }}">
                                                <div class="symbol-label">
                                                    <img src="{{ asset('admin/media/category/${row.img}') }}"
                                                        alt="${row.name}" class="w-100" />
                                                        <!--<i class="fa-regular ${row.icon} fs-1 text-dark"></i>-->
                                                </div>
                                            </a>
                                        </div>
                    ...
                    },
                    {
                        data: 'created_by',
                        render: function(data, type, row, meta) {
                            let created_by_class = (row.created_by == 'vendor') ? 'badge-primary' :
                                'badge-success';
                            return `<div class="badge ${created_by_class} fw-bolder">
                                        ${row.created_by}
                                    </div>`;
                        }
                    },
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                            <li class="text-center"><a class="dropdown-item" href="{{ route('management.user_management.view') }}">Add Sub-Category</a></li>
